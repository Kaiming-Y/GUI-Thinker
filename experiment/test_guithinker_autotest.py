...
folder_map = {
    "w/o Planner-Critic": "guithinker-wo-planner_critic",
    "w/o Step-Check": "guithinker-wo-step_check",
    "w/o Actor-Critic": "guithinker-wo-actor_critic",
    "w/o inst. video": "guithinker-wo-inst-video",
}
...
if not ablation:
    folder_name = "guithinker"
else:
    folder_name = folder_map.get(ablation_exp, "unknown")
saved_folder = os.path.join(base_folder, folder_name, basic_config['planner_critic']['lmm'])
